...
class PredictionWorker(QThread):
    ...
    def run(self):
        try:
            ...
            self.finished_signal.emit(True, "Predictions completed successfully!", predictions)
...
class ModelPredictionDialog(QDialog):
    ...
    def initUI(self):
        ...
        if self.document:
            doc_info = QLabel(f"Document: {self.document.filename}, Page: {self.page_idx + 1}")
    ...
    def update_model_options(self):
        ...
        if os.path.exists("trained_model"):
            trained_models = [f for f in os.listdir("trained_model") 
    ...
    def select_model(self):
        ...
        if model_dir:
            ...
            if os.path.exists(os.path.join(model_dir, "config.json")):
                ...
                QMessageBox.warning(self, "Invalid Model Directory", 
    ...
    def run_prediction(self):
        ...
        if not self.document:
            QMessageBox.warning(self, "No Document", "No document is selected for prediction.")
            return
